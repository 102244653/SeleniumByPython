...
class TypeManageActivity:
    ...
    # 新增
    create_btn = ('id', 'typeManage-add')


global page


class TypeManagePage(BasePage):

    def __init__(self, driver):
        super().__init__(driver)
        global page
        page = TypeManageActivity()

    def simple_query_type(self, _type=None):
        """
        设备类别查询
        :param _type:
        :return:
    ...
    def view_type_detail(self, index=1):
        """
        查看型号详情
        :param index:
        :return:
    ...
    def click_on_off_btn(self, index=1):
        ...
        """
        # 开启
        on_off_btn = ('xpath', '//div[@id="main"]/div/div/div/div[2]/div[3]/table/tbody/tr[{}]/td[4]/div/div/span'.format(index))
