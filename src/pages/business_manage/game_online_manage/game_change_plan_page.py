...
class GameChangePlanActivity:
    ...
    # 新建试玩计划
    creat_change_plan_btn = ('id', 'gameChangePlanList-add')


global page


class GameChangePlanPage(BasePage):
    """
    试玩计划
    """
    ...
    def click_creat_change_plan(self):
        """
        点击新增变更计划
        """
        self.click_element(page.creat_change_plan_btn)

    def view_change_plan(self, index=1):
        """
        查看试玩计划
        """
        # 查看
    ...
    def edit_change_plan(self, index=1):
        """
        编辑试玩计划
        """
        # 编辑
