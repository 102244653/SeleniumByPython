...
class PartsListActivity:
    ...
    # 配件名称
    device_input = ('xpath', '//*[@placeholder="请输入配件名称"]')
...
class PartsListPage(BasePage):
    ...
    def simple_query_parts(self, store=None, channel=None):
        """
        查询
        :param store:
        :param channel:
    ...
    def click_view_parts_detail(self, index=1):
        """
        查看详情
        :param index:
        :return:
    ...
    def click_view_parts_record(self, index=1):
        """
        查看履历
        :return:
        """
